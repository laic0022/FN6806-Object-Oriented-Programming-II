...
// Getters
template<class T1, class T2>
inline T1 Pair<T1, T2>::left() const {
    return _left;
}

template<class T1, class T2>
inline T2 Pair<T1, T2>::right() const {
    return _right;
}

// Setters
template<class T1, class T2>
inline void Pair<T1, T2>::left(const T1 &a) {
    _left = a;
}

template<class T1, class T2>
inline void Pair<T1, T2>::right(const T2 &b) {
    _right = b;
}
